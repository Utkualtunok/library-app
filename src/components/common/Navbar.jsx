                            ...
                            {pages.map((page) => (
                                <MenuItem key={page.name} onClick={handleCloseNavMenu}>
                                    <Link to={page.path} style={{
                                        color: '#76ABAE', textDecoration: 'none',
                                    }}>{page.name}</Link>
                                </MenuItem>
                            ))}
                        </Menu>
                    </Box>
                    <LibraryBooksIcon sx={{ display: { xs: "flex", md: "none" }, mr: 1, color: '#F5F5F5' }} />
                    <Typography
                        variant="h5"
                        noWrap
                        component="a"
                    ...
                    <Box sx={{ flexGrow: 1, display: { xs: "none", md: "flex" } }}>
                        {pages.map((page) => (
                            <Button
                                ...
                                sx={{ my: 2, color: '#F5F5F5', display: 'block', '&:hover': { color: '#F99417' } }}
                            >
                                <Link to={page.path} style={{ color: '#F5F5F5', textDecoration: 'none' }}>{page.name}</Link>
                            </Button>
                        ))}
                    </Box>
